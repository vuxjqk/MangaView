        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <form action="{{ route('comics.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Nhập mô tả về truyện tranh...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            <button type="button" onclick="window.location.href='{{ route('comics.index') }}'"
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul class="text-sm text-blue-700 space-y-1">
                    ...
                    <li>• Bạn có thể chọn nhiều thể loại cho truyện</li>
                    <li>• Truyện sau khi tạo sẽ cần được phê duyệt trước khi hiển thị công khai</li>
                    <li>• Bạn có thể cập nhật thông tin truyện sau khi tạo</li>
                </ul>
            </div>
        </div>
    </div>
